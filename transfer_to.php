...
<body>
	...
	<center>
		<div class="view">
			<br><br><h2 style=" font-size:55px;color:#e0115f;text-shadow: 0px 0px black;">Transfer Amount</h2>
			<form action="checkcredit.php" method="post" >
				<div class="border">
				<table>
					<tr>
						<td style="font-size:16pt;color:#010114;">
       ...
       <tr>
			<td>
				<div class="button">
				<br> &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; &nbsp;<button type="submit" class="c" onMouseOver="this.style.color='brown'"onMouseOut="this.style.color='black'" value="Credit" style="color:black;font-size:22px;height:40px; width:100px;">Transfer</button>
				</div>
		   </td>
        </tr>
       </table>
